...
export default class CellEditorInput extends Component {
  static displayName = 'CellEditorInput';
  ...
  render() {
    ...
    return (
      <div className="cellEditorInput">
        ...
        <span
          style={styles.operationIcon}
          className="cellEditorInput-trigger"
          title="编辑"
